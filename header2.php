...
<!--<![endif]-->
    ...
    <body>
		...
		<div class="bgtopo2">
			...
			<div class="container">
				<div class="logo2 fl">
					<a href="index.php" title=""><img src="imagens/logo2.png" alt=""></a>
				</div>

				<div class="flags fr"><br>
					<a href="#" title=""><img src="imagens/brasil.png" alt=""></a>
					<a href="#" title=""><img src="imagens/eua.png" alt=""></a>
				</div>
				<div class="cls"></div>
				<div id="menu2">
				<nav class="nav">
